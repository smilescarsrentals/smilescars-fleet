...
const READS = {
  ...
  getPreviousSupplierPrice: reads.getPreviousSupplierPrice,
  ...
  getCurrentGarageAssignment: reads.getCurrentGarageAssignment,
  getDriverLeaveRecords: reads.getDriverLeaveRecords,
  getDriverAssignmentLog: reads.getDriverAssignmentLog,
  getDriverCurrentAssignments: reads.getDriverCurrentAssignments,
  getDriversByClientHistory: reads.getDriversByClientHistory,
  ...
  getHRStaffList: reads.getHRStaffList,
  getHRStaffProfile: reads.getHRStaffProfile,
  getMyProfile: reads.getMyProfile,
  getMyLeaveRequests: reads.getMyLeaveRequests,
  getHRLeaveRequests: reads.getHRLeaveRequests,
  getMyDisciplinaryRecords: reads.getMyDisciplinaryRecords,
  getHRDisciplinaryRecords: reads.getHRDisciplinaryRecords,
  getOnboardingChecklist: reads.getOnboardingChecklist,
  getWorkflowInvoices: reads.getWorkflowInvoices,
  getWorkflowInvoiceEvents: reads.getWorkflowInvoiceEvents,
  getCoverNotesForCar: reads.getCoverNotesForCar,
  getFleetCoverNoteStatus: reads.getFleetCoverNoteStatus,
...
const WRITES = {
  ...
  changeFleetGarage: writes.changeFleetGarage,
  ...
  setReceivesInsuranceReminders: writes.setReceivesInsuranceReminders,
  setCanManageDrivers: writes.setCanManageDrivers,
  setCanIssueFuelVoucher: writes.setCanIssueFuelVoucher,
  setStaffLocation: writes.setStaffLocation,
  setHRAccess: writes.setHRAccess,
  setIsCoo: writes.setIsCoo,
  saveHRStaffProfile: writes.saveHRStaffProfile,
  submitLeaveRequest: writes.submitLeaveRequest,
  ...
  addLeaveOnBehalf: writes.addLeaveOnBehalf,
  editLeaveRequestDates: writes.editLeaveRequestDates,
  ...
  toggleOnboardingItem: writes.toggleOnboardingItem,
  deleteOnboardingItem: writes.deleteOnboardingItem,
  uploadWorkflowInvoice: writes.uploadWorkflowInvoice,
  resubmitWorkflowInvoice: writes.resubmitWorkflowInvoice,
  reviewWorkflowInvoice: writes.reviewWorkflowInvoice,
  scanCoverNote: writes.scanCoverNote,
  confirmCoverNote: writes.confirmCoverNote,
  discardCoverNotePreview: writes.discardCoverNotePreview,
  addDriverV2: writes.addDriverV2,
  setDriverLeaveDaysAvailable: writes.setDriverLeaveDaysAvailable,
  addDriverLeaveRecord: writes.addDriverLeaveRecord,
  editDriverLeaveRecord: writes.editDriverLeaveRecord,
  ...
  runTrackerSyncNow: writes.runTrackerSyncNow,
