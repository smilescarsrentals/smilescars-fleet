...

{
  ...
  "items": [
    { "itemName": "string", "quantity": <number>, "unitPrice": <number or null>, "lineTotal": <number or null> }
  ]
}
...
- If the image isn't a readable invoice/receipt at all, return {"supplierName": null, "invoiceDate": null, "totalAmount": null, "items": []}.
