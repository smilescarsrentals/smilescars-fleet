...
const NUMERIC = {
  fleet: ["amount", "amount_paid", "police_fine_out", "parking_fine_out"],
  ...
  fuel: ["current_km"],
  maintenance_log: ["parts_cost", "labor_cost", "total_cost"],
};
const TIMESTAMP = {
  fleet: ["booked_from", "return_date"],
  history: ["timestamp", "booked_from", "return_date"],
  sub_hire: ["booked_from", "return_date", "actual_return", "timestamp"],
  fuel: ["timestamp", "date"],
  reservations: ["pickup_date", "return_date", "timestamp", "transfer_date"],
  sold: ["timestamp"],
  blacklist: ["timestamp"],
  agreements: ["timestamp"],
  export_log: ["timestamp"],
  maintenance_log: ["date_opened", "date_closed"],
};
