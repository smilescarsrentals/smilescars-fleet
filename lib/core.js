...
// Phase 2c: only these notification types actually send a push — the
// other 4 (from the original 6-trigger list) still create the in-app
// bell notification as before, just without a push alongside it yet.
// Rolling out the rest in Phase 2d is just adding to this list; the
// send mechanism itself doesn't change.
const PUSH_ENABLED_TYPES = new Set(["fleet_to_garage", "reservation_reminder"]);
