...
const mapMaintenance = (r) => ({
  ...
  externalVendorId: S(r.external_vendor_id), flatCost: r.flat_cost != null ? Number(r.flat_cost) : null,
});
...
export async function getVendors() {
  ...
  // Attach each vendor's categories in one extra query rather than N+1.
