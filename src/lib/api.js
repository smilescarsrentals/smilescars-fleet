...
export const api = {
  ...
  getDriverLicenseDocsForCleanup: (staffName) => get("getDriverLicenseDocsForCleanup", { staffName }),
  ...
  previewDriverLicenseCleanup: (body) => post({ action: "previewDriverLicenseCleanup", ...body }),
  applyDriverLicenseCleanup: (body) => post({ action: "applyDriverLicenseCleanup", ...body }),
  discardDriverLicenseCleanupPreview: (body) => post({ action: "discardDriverLicenseCleanupPreview", ...body }),
