            ...
            {paginated.map(car => {
              ...
              return (
                <tr key={car.plate} style={isExpired ? { background: "#fef2f2" } : isExpiringSoon ? { background: "#fffbeb" } : {}}>
                  ...
                  <td style={{ ...styles.td, fontSize: 13, color: isExpired ? "#b91c1c" : isExpiringSoon ? "#b45309" : "#555" }}>
                  ...
                  <td style={styles.td}>
                    <ActionButtons car={car} onAction={(c,a) => setModal({car:c,action:a})} onMove={(c) => setMoveCar(c)} />
                  </td>
                </tr>
              );
            })}
...
function ActionButtons({ car, onAction, onMove }) {
  ...
  if (car.status === "Available") return (
    <div>
      ...
      {btn("Sold",        "markSold",       "#dc2626", "#fef2f2")}
    </div>
  );
